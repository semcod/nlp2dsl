...
install_one "$ROOT/dsl2nlp2dsl"
install_one "$ROOT/uri2nlp2dsl"
install_one "$ROOT/nlp2nlp2dsl"
install_one "$ROOT/cli2nlp2dsl"
install_one "$ROOT/mcp2nlp2dsl"
install_one "$ROOT/rest2nlp2dsl"
