...
### Test
- Update tests/local.dev.txt

### Other
- Update .env.example
- Update backend/local.dev.txt
- Update local.dev.txt
- Update nlp-service/local.dev.txt
- Update packages/cli2nlp2dsl/local.dev.txt
- Update packages/dsl-contracts/local.dev.txt
- Update packages/dsl-validate/local.dev.txt
- Update packages/dsl2nlp2dsl/local.dev.txt
- Update packages/mcp2nlp2dsl/local.dev.txt
- Update packages/nlp2cmd-intent/local.dev.txt
- ... and 16 more files
...
- Update nlp-service/app/routing/resolve.py
- Update packages/nlp2cmd-intent/src/nlp2cmd_intent/data_files.py
- Update packages/nlp2cmd-intent/src/nlp2cmd_intent/input.py
- Update packages/nlp2cmd-intent/src/nlp2cmd_intent/keywords/keyword_patterns.py
...
- Update examples/08-multi-object-benchmark/results/benchmark_1780752985.json
- Update examples/15-idempotency-replay/scenario.py
- Update examples/16-golden-eval/results/golden_1780753164.json
- Update examples/bootstrap.py
- Update examples/testql-results.json
- Update nlp2dsl_sdk/artifact_layout.py
- Update nlp2dsl_sdk/artifacts.py
...
### Other
- Update examples/08-multi-object-benchmark/results/benchmark_1780751306.json
- Update examples/16-golden-eval/results/golden_1780751517.json
- Update examples/testql-results.json
- Update project/analysis.toon.yaml
- Update project/calls.mmd
...
- Update tests/test_contract_draft.py
- Update tests/test_contract_drift.py
- Update tests/test_golden_eval.py
- Update tests/test_mullm_client.py
- Update tests/test_nlp2dsl_sdk.py
- Update tests/test_workflow_events.py
- Update tests/test_workflow_simulate.py
...
- Update backend/app/execution_policy.py
- Update backend/app/idempotency.py
- Update backend/app/mullm_execute.py
...
- Update tests/test_action_contracts.py
- Update tests/test_conversation_testql.py
- Update tests/test_workflow_lifecycle.py

### Other
- Update backend/app/action_catalog.py
- Update backend/app/routers/workflow.py
- Update backend/tests/test_workflow_api.py
- Update examples/08-multi-object-benchmark/results/benchmark_1780741913.json
- Update examples/testql-results.json
- Update nlp-service/app/conversation/responses.py
- Update nlp-service/app/dsl/pipeline.py
- Update nlp-service/app/registry.py
- Update nlp-service/app/routers/nlp.py
- Update nlp-service/app/routing/parser/enrich.py
- ... and 29 more files
