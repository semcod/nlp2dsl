...
- [x] `nlp2dsl_sdk/mullm/client.py` — `POST {MULLM_API_URL}/api/commands/tasks`
- [x] Backend auto-wykonuje Mullm (`execute_mullm_dsl`, chat `uruchom`, `/workflow/execute`)
...
| `MULLM_API_URL` | `http://localhost:8080` | Backend Mullm orchestrator |
| `MULLM_DELEGATE_MODE` | `auto` | `live` / `simulate` / `auto` |
